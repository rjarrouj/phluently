                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <!-- <div class="col-md-1 pl-0 pr-0 col-2 pt-2 text-right">
                                <h6 class="text-primary" style="cursor:pointer;" modal-1 @click="fillContactDetails(job)">Contact</h6>    
                            </div> -->
                        </div>
                    </div>
                </div>
