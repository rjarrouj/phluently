    ...
    <div class="card mt-3">
        <div class="card-body">
            <div class="text-center">
                <b-img v-bind="mainProps" rounded="circle" :src="user.profile_image != null ? user.profile_image : demoImage" alt="Circle image"></b-img>
            </div>
            <div class="row pt-2">
            ...
            <div class="row">
                <button class="btn btn-primary btn-block mx-3" @click="profilePage">View Profile</button>
            </div>
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        profilePage() {
            this.$router.push({path: '/interpreter/profile'})
        }
    }
}
</script>